...
o1 = session.openOdb(name='C:/WINDOWS/system32/Job_Anisotropic_3.odb', readOnly=False)
odb = session.odbs['C:/WINDOWS/system32/Job_Anisotropic_3.odb']
...
with open('U1_List_3.txt', 'w') as file:
    for item in U1_List:
        file.write("%s,\n" % item)
...
with open('U2_List_3.txt', 'w') as file:
    for item in U2_List:
        file.write("%s,\n" % item)
...
with open('Stress_List_3.txt', 'w') as file:
...
with open('External_Energy_List_3.txt', 'w') as file:
...
with open('X_List_3.txt', 'w') as file:
    for item in X_List:
        file.write("%s,\n" % item)
...
with open('Y_List_3.txt', 'w') as file:
    for item in Y_List:
        file.write("%s,\n" % item)
